<template id="submodule-detail">
    <div>
        <div 
            class="portlet box green-dark" 
            style="background-color:transparent; border:none; margin-top: -10px;"  
        >
            <div 
                class="portlet-title" 
                style="min-height: 40px;background-color: #f5f5f5;border-bottom: 1px solid #e6dede;"  
                :style="showTab ? 'position: sticky;z-index:9999;top:<?= (!isset($show_homebar) || $show_homebar=='yes')?'33px':' 0px' ?>;':'' "
            >
                <header-component  :submodule="submodule" :key="submodule.code" :components="components" :objects="objects"></header-component>
                <div 
                ...
                >
                    ...
                    >
                        ...
                        <span v-show="vm.itemSearchString!=''" style="color:#737373;position:absolute;right:20px;top:2px;cursor:pointer;" @click="clearSearch()"><i class="la la-times" style="font-size: 0.9em;font-weight: bold;"></i></span>
                    </div>
                            ...
                            <div class="">
                                ...
                                <div style="overflow: auto;max-height: calc(80vh - 115px);padding-bottom: 5px; min-height:250px;"> 
                                    <search-option
                                            ...
                                            :filter="filter" :reset_filter="reset_filter" :show_all_object="showMultiOneObject" :taskcode="9999" :show_filter="show_filter" :apply_filter="apply_filter" :check_filter="check_filter" :cancel_filter="cancel_filter"
                                    ></search-option>
                                </div>
                                <div style="height:65px;padding:16px;display:flex; align-items: center; justify-content: flex-end;">
                                    <button type="button" class="btn" @click="cancelFilter()" style ="font-weight:bold; width:100px; height:40px; background:#eee;color:#737373 !important; border:none;border-radius: 4px !important;">Cancel</button>    
                                    <button type="button" class="btn" @click="applyFilter()" style ="font-weight:bold; width:100px; margin-left:10px; height:40px; background:#009688;color:#fff; border:none;border-radius: 4px !important;">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="btn-group btn-theme-panel dropdown toparea" style="margin-top:0;" v-show="show_button && (vm.activeScreenSub.indexOf(submodule.code)<0 && showSearch)">
                ...
                >
                    ...
                    >
                        ...
                        <span v-show="keyword != ''" style="color:#737373;position:absolute;right:20px;top:2px;cursor:pointer;" @click="clearSearch2()"><i class="la la-times" style="font-size: 0.9em;font-weight: bold;"></i></span>
                    ...
                    >
                        <div 
                            ...
                            :style="submodule.layout != 'tiles' ? showTab ? {'overflow-y': 'auto',
                                ...
                                'scrollbar-width': 'none'}: ''
                            " 
                            v-if="(component.subModuleCode == submodule.code) && (!component.hasOwnProperty('is_header') || (component.hasOwnProperty('is_header') && component.is_header !== 1))"  

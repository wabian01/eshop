        ...
        <div :id="random" class="carousel slide" data-interval="false" style="padding-bottom:40px;">
            ...
            <div class="carousel-inner" >
                <div class="item" v-for="(list_item,index) in list_items" :class="index==0?'active':''" style="padding:5px;">
                    <list-item :horizontal='true'  :indexsearch="list_items.length-1<index+2" :key="list_item" :screen_item="body_area" :list_item="list_item" :object="object" :task="task" :position='index'></list-item>
                </div>
            </div>
        </div>
    </div>

...
<template id="system-edit-form-object">
    <div class="webapp-detailmodule">
        <div class="fillsystem-form-object"  v-on:click="vm.openInstanceList(object)">
            ...
            <div class="f-label-middle">
                ...
                <span class="f-label"></span><span class="f-text">{{object.version}}</span>
            </div>
            <span class="f-notification-badge pull-right">{{object.instanceCount}}</span>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    Vue.component('system-edit-form-object', {
        template: '#system-edit-form-object',
        props: ['object','onClickForm'],
        data: { 
            b_color: '#f36a5a',
            column: 0,
        },

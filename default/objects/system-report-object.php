...
<template id="system-report-object">
    <div class="webapp-detailmodule">
        <div class="fillsystem-form-object"  v-on:click="vm.openTask(object,layout, subitem, comitem)">
            ...
            <span class="f-label f-updatetime">{{object.updatedDate}}</span>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    Vue.component('system-report-object', {
        template: '#system-report-object',

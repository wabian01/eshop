<template id="timeline-item">
    <div class="timeline-item">
        ...
        <div class="timeline-body">
            <div>
                <span class="timeline-date_column" style="color: #6a6565;font-size: 12px;" v-html="item_content.date_column"></span>
                <span class="timeline-extra_text_column" v-html="item_content.extra_text_column"></span>
            </div>
            <div class="timeline-item_template" v-html="item_content.item_template ? item_content.item_template : item_content.title_column"></div>
        </div>
    </div>
</template>
